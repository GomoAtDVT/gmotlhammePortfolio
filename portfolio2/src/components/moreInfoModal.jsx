...
const MoreInfoModal = ({ isOpen, onClose ,service}) => {
    ...
    return (
        ...
        <div id="modal-overlay" className='h-full w-full z-3 top-0 fixed backdrop-blur-xs' onClick={onClose}>
            <div id="modal-content" className="animate-popOut w-90 lg:h-150 lg:w-150 z-100 fixed top-70 lg:top-20 lg:left-110 left-4 bg-[url('/white-waves.jpg')] dark:bg-[url('/dark-modal2.jpg')] bg-cover bg-left rounded-xl " onClick={(e) => e.stopPropagation()}>
