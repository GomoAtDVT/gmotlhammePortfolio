    ...
    return (
        ...
        <section
          ...
          >
            <div
              id="first-project"
              className='bg-[url("./soft-performance.jpg")] backdrop-blur-2xl dark:text-white dark:bg-[url("./blend.jpg")] bg-cover bg-bottom font-semibold flex justify-around items-center rounded-lg lg:h-120 sm:h-fit lg:col-span-2 p-5 sm:gap-5'
            >
            ...
            <div
              id="second-project"
              className='bg-[url("./soft-performance.jpg")] dark:text-white dark:bg-[url("./blend.jpg")] bg-cover bg-left flex flex-col  justify-center gap-15 lg:col-span-1 sm:col-span-2 items-center text-center rounded-lg p-3 '
            >
            ...
            <div
              id="third-project"
              className='bg-[url("./soft-performance.jpg")] dark:text-white dark:bg-[url("./blend.jpg")] bg-cover bg-left  flex flex-col items-center lg:text-center p-3 justify-center gap-15 rounded-lg lg:h-120 sm:h-fit lg:col-span-1 sm:col-span-2'
            >
            ...
            <div
              id="fourth-project"
              className='bg-[url("./soft-performance.jpg")] dark:text-white dark:bg-[url("./blend.jpg")] bg-cover bg-bottom  flex justify-around items-center rounded-lg py-6 col-span-2 sm:gap-5 sm:px-5'
            >
