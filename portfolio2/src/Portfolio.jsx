...
// });
    ...
    <>
        <header className="bg-white dark:bg-[url('./black-spheres.jpg')] bg-cover bg-right p-5 m-2 rounded-lg h-170">
            ...
            <nav className='dark:text-white hidden md:flex'>
                <ul className='flex gap-30 text-md font-semibold '>
                    <li className='hover:text-indigo-600 dark:hover:text-amber-600'><a href="#services">SERVICES</a></li>
                    <li className='hover:text-indigo-600 dark:hover:text-amber-600'><a href="#about">ABOUT</a></li>
                    <li className='hover:text-indigo-600 dark:hover:text-amber-600'><a href="#projects-banner">PROJECTS</a></li>
                    <li className='hover:text-indigo-600 dark:hover:text-amber-600'><a href="#technologies">TECHNOLOGIES</a></li>
                </ul>
            </nav>
            ...
            <nav  className='bg-zinc-200  dark:bg-zinc-800 p-4 w-80 dark:text-white flex flex-col justify-end absolute top-10 right-10 z-2 '>
                <button onClick={sidebarBtn} className="flex justify-end m-4 cursor-pointer dark:font-light hover:text-indigo-600 dark:hover:text-amber-600">CLOSE</button>
                <hr />
                <ul className='flex flex-col gap-10 m-4 my-5 text-md dark:font-light'> 
                    <li className='hover:text-indigo-600 dark:hover:text-amber-600'><a onClick={sidebarBtn} href="#services">SERVICES</a></li>
                    <li className='hover:text-indigo-600 dark:hover:text-amber-600'><a onClick={sidebarBtn} href="#about">ABOUT</a></li>
                    <li className='hover:text-indigo-600 dark:hover:text-amber-600'><a onClick={sidebarBtn} href="#projects-banner">PROJECTS</a></li>
                    <li className='hover:text-indigo-600 dark:hover:text-amber-600'><a onClick={sidebarBtn} href="#technologies">TECHNOLOGIES</a></li>
                    <hr />
                
                    <div className="dark:font-light ">
                        
                        <button onClick={changeAppearence}  className="dark:font-light hover:text-indigo-600 dark:hover:text-amber-600 cursor-pointer">APPEARENCE</button>
                        
                        <div  id="toggle-container" className="invisible mt-2">
                            <p onClick={lightMode} className="p-2 ml-7 hover:text-indigo-600 dark:hover:text-amber-600 cursor-pointer">LIGHT</p>
                            <p onClick={darkMode} className="p-2 ml-7 hover:text-indigo-600 dark:hover:text-amber-600 cursor-pointer">DARK</p>
                        </div>
        ...
        <main className=' dark:bg-transparent m-2 grid grid-cols-2 gap-5 mb-75'>
            ...
            {/* services section  */}
        <section id='services' className='flex rounded-lg justify-end p-5 font-semibold bg-white dark:bg-[url("./blend.jpg")] bg-cover dark:text-white h-110 text-5xl '>EXPLORE MY <br></br> SERVICES</section>
...
Beyond code, I care deeply about clean design, performance, and solving real-world problems through technology. I've collaborated on projects that range from improving company websites to building systems from scratch, and I enjoy taking ownership from concept to deployment.</p>
        ...
        <section id='projects-banner' className='bg-white dark:bg-[url("./blend.jpg")] bg-cover bg-center rounded-lg h-50 col-span-full flex justify-between p-5'>
...
<div className='flex flex-col gap-2 w-full'>
    ...
    />.
                        ...
                        <button className='text-white bg-black h-10 rounded mt-5 cursor-pointer shadow-md active:shadow-none hover:text-blue-500 dark:hover:border-amber-400  dark:hover:text-amber-500 dark:text-green'>Send Message</button>

                </form>
            </section>
            <section id='technologies' className='bg-blue-600 dark:bg-[url("./peach-cube.jpg")] bg-cover rounded-lg col-1 row-1 md:col-2 '>b</section>
        </footer>
    </>
